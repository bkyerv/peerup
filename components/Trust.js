  ...
  return (
    <>
      <div className="mt-24">
        ...
        <div className="mt-8 px-4 flex sm:flex-row flex-col gap-4">
          {feedback.map((i) => {
...
function Card({ imgPath, name, message }) {
  return (
      <div className="bg-gradient-to-br from-blue-50 to-yellow-50 py-4 px-8 shadow-md rounded-md flex flex-col gap-4">
